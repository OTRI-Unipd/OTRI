import unittest
from otri.filtering.filters.group_filter import GroupFilter
...
EXPECTED_1_DAY = [
    {"datetime": "2020-08-10 00:00:00.000", "open": "3.0", "close": "5.0", "high": "9.0", "low": "0.5"},
    {"datetime": "2020-08-11 00:00:00.000", "open": "1.0", "close": "1.0", "high": "2.0", "low": "1.0"}
]
...
EXPECTED_2_MIN = [
    {"datetime": "2020-08-10 08:00:00.000", "open": "3.0", "close": "6.0", "high": "9.0", "low": "2.0"},
    {"datetime": "2020-08-10 09:44:00.000", "open": "1.0", "close": "5.0", "high": "5.0", "low": "0.5"},
    {"datetime": "2020-08-11 09:02:00.000", "open": "1.0", "close": "1.0", "high": "2.0", "low": "1.0"}
]

EXPECTED_5_MIN = [
    {"datetime": "2020-08-10 08:00:00.000", "open": "3.0", "close": "6.0", "high": "9.0", "low": "2.0"},
    {"datetime": "2020-08-10 09:45:00.000", "open": "1.0", "close": "5.0", "high": "5.0", "low": "0.5"},
    {"datetime": "2020-08-11 09:00:00.000", "open": "1.0", "close": "1.0", "high": "2.0", "low": "1.0"}
]

EXPECTED_1_HOUR = [
    {"datetime": "2020-08-10 08:00:00.000", "open": "3.0", "close": "6.0", "high": "9.0", "low": "2.0"},
    {"datetime": "2020-08-10 09:00:00.000", "open": "1.0", "close": "5.0", "high": "5.0", "low": "0.5"},
    {"datetime": "2020-08-11 09:00:00.000", "open": "1.0", "close": "1.0", "high": "2.0", "low": "1.0"}
]

EXPECTED_2_HOUR = [
    {"datetime": "2020-08-10 08:00:00.000", "open": "3.0", "close": "5.0", "high": "9.0", "low": "0.5"},
    {"datetime": "2020-08-11 08:00:00.000", "open": "1.0", "close": "1.0", "high": "2.0", "low": "1.0"}
]
...
class AlignFilterTest(unittest.TestCase):
    ...
    def __test(self, resolution: timedelta, expected: dict):
        group_filter = GroupFilter(inputs="A", outputs="B", resolution=resolution, datetime_key="datetime")
